...
Deepnote integration is URL/template-only. No Deepnote notebook archive or copied interview-note bundle is distributed in `public/` or `dist/`. User-configured links remain external and retain their own provider/content terms.
